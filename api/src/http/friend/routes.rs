...
use crate::http::{friend::handlers::{accept_friend_request, create_friend_request, decline_friend_request, delete_friend, delete_friend_request, get_friend_requests, get_friends}, server::AppState};
...
pub fn friend_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/friends/requests/{user_id_invited}", delete(delete_friend_request))
}